...
export default function RegisterPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      <h1 className="text-xl font-bold mb-4 text-purple-950">Register</h1>
      <form onSubmit={handleRegister} className="space-y-4 w-64">
        ...
        <button className="w-full bg-purple-500 text-white p-2 rounded" type="submit">Sign Up</button>
      </form>
      <button
